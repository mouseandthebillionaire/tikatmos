...
namespace STTClient
{
    ...
    public class STT : ISTT
    {
        ...
        public unsafe void FeedAudioContent(STTClient.Models.Stream stream, short[] aBuffer, uint aBufferSize)
        {
        ...
        public unsafe string FinishStream(STTClient.Models.Stream stream)
        {
        ...
        public unsafe Metadata FinishStreamWithMetadata(STTClient.Models.Stream stream, uint aNumResults)
        {
        ...
        public unsafe string IntermediateDecode(STTClient.Models.Stream stream)
        {
        ...
        /// <param name="aNumResults">Maximum number of candidate transcripts to return. Returned list might be smaller than this.</param>
        /// <returns>The STT intermediate result.</returns>
        public unsafe Metadata IntermediateDecodeWithMetadata(STTClient.Models.Stream stream, uint aNumResults)
        {
        ...
        /// </summary>
        public unsafe void FreeStream(STTClient.Models.Stream stream)
        {
