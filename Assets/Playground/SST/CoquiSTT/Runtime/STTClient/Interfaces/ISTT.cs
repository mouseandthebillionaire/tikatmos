...
namespace STTClient.Interfaces
{
    ...
    public interface ISTT : IDisposable
    {
        ...
        /// </summary>
        unsafe STTClient.Models.Stream CreateStream();
        ...
        unsafe void FeedAudioContent(STTClient.Models.Stream stream, short[] aBuffer, uint aBufferSize);
        ...
        unsafe string IntermediateDecode(STTClient.Models.Stream stream);
        ...
        unsafe Metadata IntermediateDecodeWithMetadata(STTClient.Models.Stream stream, uint aNumResults);
        ...
        unsafe string FinishStream(STTClient.Models.Stream stream);
        ...
        /// <param name="aNumResults">Maximum number of candidate transcripts to return. Returned list might be smaller than this.</param>
        /// <returns>The extended metadata result.</returns>
        unsafe Metadata FinishStreamWithMetadata(STTClient.Models.Stream stream, uint aNumResults);
    }
}
